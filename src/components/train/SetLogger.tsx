  ...
  return (
    <div className="bg-[var(--bg-inset)] border border-[var(--border-soft)] rounded-lg mb-2.5 overflow-hidden">
      ...
      <div className="p-3">
        ...
        <button
          onClick={addSet}
          className="tap-scale w-full mt-1 text-[11px] font-bold uppercase tracking-wide text-[var(--accent-2)] border border-dashed border-[rgba(155,140,255,0.3)] rounded-md py-1.5"
        >
          + Add Set
        </button>
      </div>
