...
const base =
  "w-full bg-[var(--bg-inset)] border border-[var(--border)] rounded-xl px-3.5 py-3 text-[15px] font-medium text-[var(--text)] outline-none focus:border-[var(--accent)] focus:shadow-[0_0_0_3px_rgba(4,55,242,0.18)] transition-shadow";
